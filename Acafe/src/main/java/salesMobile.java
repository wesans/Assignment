...
/**
 * Servlet implementation class sales_mobile
 */
@WebServlet("/sales_mobile")
public class salesMobile extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.setCharacterEncoding("utf-8");
	      ...
	      String sql = "select mobile, sum(total) as total1 from cafe_sales group by total,mobile order by sum(total)";
	      try {
